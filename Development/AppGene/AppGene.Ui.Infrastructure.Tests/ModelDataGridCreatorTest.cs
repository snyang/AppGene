...
namespace AppGene.Ui.Infrastructure.Tests
{
    ...
    public class ModelDataGridCreatorTest<TModel>
    {
        ...
        private void ValidateColumntBoolean(DataGridColumn gridColumn, DisplayPropertyInfo property)
        {
            Assert.IsTrue(gridColumn is DataGridCheckBoxColumn, $"property = {property.PropertyName}");
            var textColumn = (DataGridCheckBoxColumn)gridColumn;
        ...
        private void ValidateGridColumns(ModelDataGridUiInfo modelUiInfo, IList<DisplayPropertyInfo> displayProperties)
        {
            ...
            foreach (var property in columnProperties)
            {
                ...
                {
                    ValidateColumntBoolean(grid.Columns[index], property);
                }
                else if (elementType == LogicalUiElementType.Date)
                {
                    ...
                    || elementType == LogicalUiElementType.ComboBox)
                {
